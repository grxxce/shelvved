        ...
        <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
            ...
            <div
                ...
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    <form @submit.prevent="Register" class="space-y-4 md:space-y-6" action="#" novalidate>
                        <div>
                    ...
                    <p class="text-sm font-light text-gray-500 dark:text-gray-400">
                        Already have an account? <a href="/sign-in"
                            class="font-medium text-primary-600 underline hover:underline dark:text-primary-500">Login</a>
                    </p>
